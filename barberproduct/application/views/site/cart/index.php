<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 clearpaddingr">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
        <ol class="breadcrumb">
            <li><a href="<?php echo base_url(); ?>"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Trang chủ</a></li>
        ...
        ?>
            <div class="panel panel-info " style="margin-top: 20px;margin-bottom: 15px;background-color: #ffffff">
                <div class="panel-heading">
                    <h3 class="panel-title">Giỏ hàng ( <?php echo $total_items; ?>Sản phẩm)</h3>
                </div>
                <div class="panel-body" style="background-color: #ffffff">
                    <table class="table table-hover">
                        <thead style="background-color: rgb(240, 93, 64);color: #fff;font-size: 14px">
                            ...
                            <th style="text-align: center">Thêm size mới</th>
                            <th>Thành tiền</th>
                            <th>Xóa</th>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a style="font-weight: bold;color: red" href="<?php echo base_url('cart/del'); ?>">Xóa toàn bộ</a></td>

                            </tr>
                            <tr style="border: none">
                                <td colspan="8"><a style="float: right;;border: none" href="<?php echo base_url('order'); ?>" class="btn btn-success">Đặt hàng</a></td>
                            </tr>
        ...
        <?php } else { ?>
            <div class="panel panel-info " style="margin-bottom: 15px">
                <div class="panel-heading">
                    <h3 class="panel-title">Giỏ ( 0 Sản phẩm )</h3>
                </div>
                <div class="panel-body">
                    <div class="text-center">
                        <img src="<?php echo base_url('upload/cart-empty.png') ?>" alt="">
                        <h4 style="color:red">Không có sản phẩm nào trong giỏ hàng</h4>
                        <a href="<?php echo base_url('product/hot'); ?>" class="btn btn-info">Shopping</a>
                    </div>
