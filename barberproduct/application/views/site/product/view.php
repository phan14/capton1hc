<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 clearpaddingr">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
                ...
                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6" style="padding: 10px">
                    ...
                    <p>sizes:
                        ...
                        <?php if (sizeof($size_array) == 0) { ?>
                            <span>Product is Hết hàng</span>
                        <?php } ?>
                    </p>
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding" style="padding-bottom: 10px;margin-top:10px; border-bottom: 1px solid #ddd">
                            ...
                            <div class="col-sm-11">
                                ...
                                <div class="col-xs-12" style="padding-left: 0px">
                                    ...
                                    <div class="col-xs-7">Ngày đăng: <?php echo mdate(" %d/%m/%Y", $value->date); ?></div>
                                </div>
                ...
                <?php if ($check == TRUE) { ?>
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding" style="margin-top: 15px">
                        <div class="col-lg-1" style="padding: 0px">
                            <image style="max-width: 30px;float: right" src="<?php echo base_url(); ?>/upload/user-default.png">
                        </div>
                        <div class="col-lg-11">
        ...
        <div class="panel panel-info">
            <div class="panel-heading cus-color">
                <h3 class="panel-title">Những sảm phẩm tương tự</h3>
            </div>
            <div class="panel-body">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
                    <?php
