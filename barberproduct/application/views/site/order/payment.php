                    ...
                    <form action="" method="post">
                        <div class="col-md-8">
                            ...
                            <ul>
                                ...
                                <li>Phone: <b><?php echo $_SESSION["transaction"]["user_phone"] ?></b></li>
                                <li>Address: <b><?php echo $_SESSION["transaction"]["user_address"] ?></b></li>
                            </ul>
                            ...
                            <table class="table table-hover">
                                <thead style="background-color: rgb(240, 93, 64);color: #fff;font-size: 14px">
                                    ...
                                    <th style="text-align: center">Thêm kích thước mới</th>
                                    <th>Thành tiền</th>
                                </thead>
                                <tbody>
                                    <?php
