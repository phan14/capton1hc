...
<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 clearpaddingl">
    <div class="panel panel-info" style="margin-bottom: 5px;">
        <div class="panel-heading" style="background-color: #f2f2f2;color: #111">
            <h3 class="panel-title">TÌM KIẾM</h3>
        </div>
        <div class="panel-body">
            <form class="form-horizontal text-center" method="post" action="<?php echo base_url('product/search'); ?>">
                <div class="form-group form-group-sm">
                    <label class="col-sm-5 clearpaddingl control-label" for="formGroupInputSmall">Loại</label>
                ...
                <div class="form-group form-group-sm">
                    <label class="col-sm-5 control-label" for="formGroupInputSmall">Giá từ:</label>
                    <div class="col-sm-7" style="padding-left: 0px">
                ...
                <div class="form-group form-group-sm">
                    <label class="col-sm-5 control-label" for="formGroupInputSmall">Đến:</label>
                    <div class="col-sm-7" style="padding-left: 0px">
                ...
                <button class="btn btn-info" type="submit" name='submit'><i class="fa fa-search"></i> Tìm kiếm</button>
            </form>
        </div>
    </div>
