	...
	<div class="container">
		...
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding" style="margin-top: 15px;">
				<ol class="breadcrumb">
					<li><a href="#"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Trang chủ</a></li>
					...
					<div class="panel-body">
						<form class="form-horizontal" method="post" action="<?php echo base_url('user/register'); ?>">
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-offset-2 col-sm-2 control-label">Họ tên</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-offset-2 col-sm-2 control-label">Mật khẩu</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label for="inputEmail3" class=" col-sm-offset-2 col-sm-2 control-label">Nhập lại mật khẩu</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-offset-2 col-sm-2 control-label">Địa chỉ</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label for="inputEmail3" class="col-sm-offset-2 col-sm-2 control-label">Số điện thoại</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<div class="col-sm-offset-4 col-sm-7">
									<button type="submit" class="btn btn-success">Đăng ký</button>
								</div>
							</div>
						</form>
					</div>
