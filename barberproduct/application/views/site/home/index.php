<div class="row" style="margin-top: 10px">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title text-left"><img src="<?php echo base_url(); ?>upload/icon/new.gif" alt=""><a href="<?php echo base_url('product/news'); ?>" class='product_title'>Sản phẩm mới
                </a><img src="<?php echo base_url(); ?>upload/icon/new.gif" alt=""></h3>
        </div>
                ...
                ?>
                    <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3 re-padding">
                        <div class="product_item">
                            ...
                            <?php
                            if ($value->discount != 0)
                                echo '<span class="label_pro">Giảm giá</span>';
                            ?>
                            <p>
                            ...
                            if ($sl > 0) {
                            ?>
                                <a href="<?php echo base_url('cart/add/' . $value->id); ?>"><button class='btn btn-info'><span class="fa fa-shopping-cart" aria-hidden="true"></span> Thêm giỏ hàng</button></a>
                            <?php } else { ?>
                                <a style="pointer-events: none;"><button style="pointer-events: none;background-color: #333;border: none " class='btn btn-info'>Hết hàng</button></a>
                            <?php } ?>
                        </div>
                    </div>
                <?php } ?>
...
<div class="row">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title text-left"><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""><a href="<?php echo base_url('ban-chay'); ?>" class='product_title'>SẢN PHẨM BÁN CHẠY NHẤT</a><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""></h3>
        </div>
        <div class="panel-body">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
                <?php
...
<div class="row">
    <div class="panel panel-info">
        <div class="panel-heading">
            <h3 class="panel-title text-left"><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""><a href="<?php echo base_url('product/views'); ?>" class='product_title'>SẢN PHẨM ĐƯỢC XEM NHIỀU NHẤT</a><img src="<?php echo base_url(); ?>upload/icon/hot.gif" alt=""></h3>
        </div>
        <div class="panel-body">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 clearpadding">
                <?php
