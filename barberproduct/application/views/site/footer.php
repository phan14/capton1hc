    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8" style="padding-top: 10px">
            <address>
                ...
                <span class="glyphicon glyphicon-home" aria-hidden="true"></span> Address: UTE - Cao Thắng - Đà Nẵng<br>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="footer__about">
                    <div class="footer__logo">
                        <a href="<?php echo base_url(); ?>" style="pointer-events: none;padding: 20px;"><img src="<?php echo base_url(); ?>../../../../../images/Screenshot_5.png" alt="" class="img-responsive"></a>
                    </div>
            ...
            <div class="col-lg-2 offset-lg-1 col-md-3 col-sm-6">
                <div class="footer__widget">
                    <h6>Barbershop</h6>
                    <ul>
                        <li><a href="<?php echo base_url('moi'); ?>">Mới</a></li>
            ...
            <div class="col-lg-3 offset-lg-1 col-md-6 col-sm-6">
                <div class="footer__widget">
                    ...
                    <div class="footer__newslatter">
                        <form action="#">
                            <input type="text" placeholder="Enter Email" style="color: #ffffff">
            ...
            <div class="col-lg-12 text-center">
                <div class="footer__copyright__text">
                    ...
                    <p>Copyright ©
                        ...
                        Mẫu này được thực hiện với <i class="fa fa-heart-o" aria-hidden="true"> C1SE.32</i> <a href="#"></a>
                    </p>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </div>
            </div>
