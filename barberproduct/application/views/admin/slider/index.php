	...
	<div class="col-lg-12">
		<div class="panel panel-info">
			<div class="panel-heading">
				...
				<div class="col-md-4 text-right"><a href="<?php echo admin_url('slider/add'); ?>" class='btn btn-info'><svg class="glyph stroked plus sign">
							<use xlink:href="#stroked-plus-sign" />
						</svg> Thêm slider</a></div>
			</div>
							...
							<?php foreach ($slider as $value) { ?>
								<tr>
									...
									<td class="list_td aligncenter">
										...
										<a href="../admin/slider/del/<?php echo $value->id; ?>" title="Delete"> <span class="glyphicon glyphicon-remove" onclick=" return confirm('Bạn chắc chắn muốn xóa')"></span> </a>
									</td>
								</tr>
							<?php } ?>
						</tbody>
