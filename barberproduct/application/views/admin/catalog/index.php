	...
	<div class="col-lg-12">
		<div class="panel panel-info">
			<div class="panel-heading">
				...
				<div class="col-md-4 text-right"><a href="<?php echo admin_url('catalog/add'); ?>" class='btn btn-info'><svg class="glyph stroked plus sign">
							...
							<?php foreach ($list as $value) { ?>
								<tr>
									...
									<td class="list_td aligncenter">
										...
										<a href="../admin/catalog/del/<?php echo $value->id; ?>" title="Delete"> <span class="glyphicon glyphicon-remove" onclick=" return confirm('Bạn chắc chắn muốn xóa')"></span> </a>
									</td>
								</tr>
							<?php } ?>
						</tbody>
