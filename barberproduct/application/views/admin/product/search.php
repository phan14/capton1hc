                    ...
                    <tbody>
                        <?php foreach ($product as $value) { ?>
                            <tr>
                                ...
                                <td style="vertical-align: middle;object-fit: contain;text-align: center;"><strong><?php echo $value->id; ?></strong></td>
                                ...
                                <td class="list_td aligncenter">
                                    ...
                                    <a id="<?php echo $value->id; ?>" title="Delete" class="remove" onclick=" return confirm('Bạn chắc chắn muốn xóa')"> <span class="glyphicon glyphicon-remove"></span> </a>
                                </td>
                            </tr>
                        <?php } ?>
