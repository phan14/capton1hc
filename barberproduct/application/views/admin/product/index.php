...
<div class="panel panel-info">
    <div class="panel-heading">
        ...
        <div class="col-md-2" style="float:right"><a href="<?php echo admin_url('product/add'); ?>" class='btn btn-info'><svg class="glyph stroked plus sign">
                    ...
                    <tbody>
                        <?php foreach ($product as $value) { ?>
                            <tr>
                                ...
                                <td style="vertical-align: middle;text-align: center;object-fit: contain;"><strong><?php echo $value->id; ?></strong></td>
                                ...
                                <td class="list_td aligncenter">
                                    ...
                                    <a id="<?php echo $value->id; ?>" title="Delete" class="remove" onclick=" return confirm('Delete sản phẩm sẽ đặt số lượng bằng 0')"> <span class="glyphicon glyphicon-remove"></span> </a>
                                </td>
                            </tr>
                        <?php } ?>
