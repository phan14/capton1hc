            ...
            <div class="panel-body">
                <form class="form-horizontal" name="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">Product's name</label>
                        <div class="col-sm-5">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                        <input type="file" require=" require" id="image" name="image" <?php echo set_value('image') ?>>
                        </div>
                      
                    </div>
                    <div class="form-group">
                        <label for="inputEmail3" class="col-sm-2 control-label">Image kèm theo</label>
                        <div class="col-sm-5">
