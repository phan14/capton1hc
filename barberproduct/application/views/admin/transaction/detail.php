					...
					<table class="table table-hover">
						...
						<tbody>
							...
							foreach ($list_product as $value) {
								$stt = $stt + 1; ?>
								<tr>
									<td style="vertical-align: middle;object-fit: contain;text-align: center;"><strong><?php echo $stt ?></strong></td>
									...
									<?php if ($transaction->status == '0') { ?>
										<td class="list_td aligncenter">
											<a href="<?php echo admin_url('transaction/deldetail/' . $value->order_id) ?>" title="Delete"> <span class="glyphicon glyphicon-remove" onclick=" return confirm('Bạn chắc chắn muốn xóa')"></span> </a>
										</td>
									<?php
									} ?>
