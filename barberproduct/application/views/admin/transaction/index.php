                                ...
                                <tr>
                                    ...
                                    <td class="list_td aligncenter">
                                        ...
                                        <?php if ($value->status != 1) { ?>
                                            <a href="<?php echo admin_url('transaction/del/' . $value->id); ?>" title="Delete"> <span class="glyphicon glyphicon-remove" onclick=" return confirm('Bạn chắc chắn muốn xóa')"></span> </a>
                                        <?php } ?>
