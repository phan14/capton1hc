							...
							?>
								<tr>
									...
									<td class="list_td aligncenter">
										...
										<a href="<?php echo admin_url('user/deldetail/' . $value->id); ?>" title="Delete"> <span class="glyphicon glyphicon-remove" onclick=" return confirm('Bạn chắc chắn muốn xóa')"></span> </a>
									</td>
								</tr>
							<?php } ?>
