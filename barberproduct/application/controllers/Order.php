    ...
    public function payment()
    {
        ...
        if ($this->input->post()) {
            ...
            if ($payment_method === "cash") {
                ...
                $this->cart->destroy();
                $vnp_Returnurl = "http://barbershop.com/barberproduct/order/thanks";
 ...
 */
                ...
                $vnp_TmnCode = "ACVMWZSV"; //Website ID in VNPAY System
                $vnp_HashSecret = "RFXOVSTLHNJHISJPRAQABFQXKCXFHARL"; //Secret key
