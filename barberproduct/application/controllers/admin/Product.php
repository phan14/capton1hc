...
class Product extends MY_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->input->post()) {
            ...
            if ($flag > 0) {
                $this->session->set_flashdata('message_success', 'Delete' . $flag . 'sản phẩm thành công');
            } else {
                $this->session->set_flashdata('message_fail', 'Delete sản phẩm thất bại');
            }
    ...
    public function add()
    {
        ...
        if ($this->input->post()) {
            ...
            // $this->form_validation->set_rules('image', 'Hình ảnh sản phẩm', 'required');
