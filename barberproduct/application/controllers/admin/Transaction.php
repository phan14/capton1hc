...
class Transaction extends MY_Controller {
    ...
    public function del() {
        ...
        if ($id != 0) {
            ...
            $this->session->set_flashdata('message_success', 'Delete đơn đặt hàng thành công');
        } else {
            $this->session->set_flashdata('message_fail', 'Delete đơn đặt hàng thất bại');
        }
        redirect(admin_url('transaction'));
    }
    ...
    public function deldetail() {
        ...
        if (!$this->order_model->check_exists($where)) {
            $this->session->set_flashdata('message_fail', 'Category không tồn tại');
            redirect(admin_url('transaction'));
        }
        ...
        if ($id != 0) {
            ...
            $this->session->set_flashdata('message_success', 'Delete thành công');
        } else {
            $this->session->set_flashdata('message_fail', 'Delete thất bại');
        }
        redirect(admin_url('transaction'));
    }
